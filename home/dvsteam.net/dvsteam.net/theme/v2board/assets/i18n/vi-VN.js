window.settings.i18n['vi-VN'] = {
    ...
    '折抵': 'Giảm giá',
    '退款': 'Hoàn lại',
    '支付方式': 'Chọn phương thức thanh toán bạn có',
    ...
    '有优惠券？': 'Nhập mã giảm vào đây(Nếu có)',
    '验证': 'Xác minh',
    '订单总额': 'Tổng tiền đơn hàng',
    '下单': 'Xác Nhận Thanh Toán',
    '总计': 'Tổng',
    ...
    '复制成功': 'Sao chép thành công',
    '复制链接': 'Sao chép đường dẫn',
    '该订阅长期有效': 'Gói này có thời gian vĩnh viễn, nhưng giới hạn lưu lượng',
    '已过期': 'Tài khoản hết hạn',
    '已用 {used} / 总计 {total}': 'Đã sử dụng {used} / Tổng dung lượng {total}',
    '重置订阅信息': 'Reset thông tin gói',
    ...
    '导入到': 'Nhập vào',
    '一键订阅': 'Đồng Bộ Sever Máy Chủ Về Máy📱',
    ...
    '立即支付': 'Chuyển đến thanh toán',
    '条工单正在处理中': ' công việc đang xử lý',
    '立即查看': 'Xem Ngay',
    '使用文档': 'Hướng dẫn & Fix lỗi',
    '我的订单': 'Đơn Hàng Của Tôi',
    '流量明细': 'Chi Tiết Dung Lượng',
    '配置订阅': 'Thiết lập gói',
    '我的邀请': 'Lời Mời Của Tôi',
    ...
    '已用流量将在 {reset_day} 日后重置': '| Lưu lượng đã sử dụng sẽ được làm mới sau {reset_day} ngày',
    '已用流量已在今日重置': ' DVSTEAM.NET',
    '重置已用流量': 'Gia hạn lại lưu lượng',
    '查看节点状态': 'Xem trạng thái nút',
    '当前已使用流量达{rate}%': 'Lưu lượng truy cập hiện đang sử dụng đạt {rate}%',
    '节点名称': 'Tên node',
    '于 {date} 到期，距离到期还有 {day} 天。': 'Hết hạn vào {date}, còn {day} ngày ',
    'Telegram 讨论组': 'Nhóm Telegram',
    '立即加入': 'Vào ngay',
    '该订阅无法续费，仅允许新用户购买': 'Gói này không thể gia hạn hoặc mua lại, chỉ được phép mua 1 lần',
    ...
    '对您当前的订阅进行购买': 'Chọn mua gói mà bạn thấy hợp với nhu cầu của mình',
    '捷径': 'Phím tắt',
    '不会使用，查看使用教程': 'Xem hướng dẫn nếu chưa biết',
    ...
    '您邀请的用户再次邀请用户将按照订单金额乘以分销等级的比例进行分成。': 'Người dùng bạn mời sẽ được chia theo tỷ lệ số lượng đặt hàng nhân với mức phân phối。'
};